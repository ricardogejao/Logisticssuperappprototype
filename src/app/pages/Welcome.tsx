...
export function Welcome() {
  ...
  return (
    <div className="relative flex flex-col min-h-screen w-full overflow-hidden bg-gradient-to-br from-amber-400 via-orange-500 to-orange-600 font-sans">
      
      {/* Background Noise/Texture Overlay (Matched to Login.tsx) */}
                    ...
                    <svg width="100" height="100" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute inset-0">
                        ...
                        >
                            {/* --- UNIFORM SQUARE GRID (80x80 blocks) --- 
                                ...
                                Spaced to create 20px wide roads at x=50, x=150 and y=50, y=150.
                            */}
